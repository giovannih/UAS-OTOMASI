...
WebUI.setText(findTestObject('Object Repository/Page_/input_Id User_id_user (3) (1) (1)'), user_id)

WebUI.setText(findTestObject('Object Repository/Page_/input_Nama Petani_nama_petani (1) (1)'), nama)

WebUI.setText(findTestObject('Object Repository/Page_/input_Tanggal Lahir_tanggal_lahir (1)'), tanggal_lahir)

WebUI.setText(findTestObject('Object Repository/Page_/input_Nama Istri  Suami_nama_istri (1) (1)'), istri)

WebUI.setText(findTestObject('Object Repository/Page_/input_Alamat Petani_alamat_petani (1) (1)'), alamat)
...
WebUI.setText(findTestObject('Object Repository/Page_/input_Nomor Telepon_nomor_telpon (1) (1)'), notelp)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Lahan_jml_lahan (1) (1)'), jumlah_lahan)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Tanggungan_jumlah_tanggungan (1) (1)'), tanggungan)

WebUI.setText(findTestObject('Object Repository/Page_/input_Jumlah Tenaga Kerja Musiman_jml_tng_k_49b205 (1) (1)'), tenaga_kerja)

WebUI.setText(findTestObject('Object Repository/Page_/input_Email_email (1) (1)'), email)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_/select_Islam                               _f363b0 (1) (1)'), 
    'Katolik', true)

WebUI.setText(findTestObject('Object Repository/Page_/textarea_Deskripsi Keahlian_deskripsi_keahlian (1) (1)'), keahlian)
...
WebUI.setText(findTestObject('Object Repository/Page_/input_Cetak Daftar_input_cari'), nama)
